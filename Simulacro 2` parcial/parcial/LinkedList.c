    ...
    if(this!=NULL && index>=0 && index<ll_len(this)){
        ...
        if(actual!=NULL){
            if(index==0){                                       //Inicio
                ...
                prev->pNextNode = actual->pNextNode;            //Uno el nodo anterior con el siguiente del actual
                free(actual);
            }
            this->size--;
            returnAux = 0;
...
/**La función “ll_count” recibirá una lista y una función “fn”.
 Se deberá iterar todos los elementos de la
...
Se deberá iterar todos los elementos de la lista y pasárselos a la función “fn”.
 La función “fn” devolverá 1 si ese ítem se debe agregar a la lista resultado o 0
  si no debe agregarse. La función “ll_filter” generará la nueva lista resultado,
